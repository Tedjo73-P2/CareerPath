        ...
        <div className="container-custom">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-slate-900">
              Welcome, {institutionData.name}! 📚
            </h1>
            <p className="text-slate-600 mt-2">
              Manage your programs, applications, and admissions
            </p>
          </div>
            ...
            {[
              {
                ...
                value: institutionData.totalStudents,
                color: "blue",
              },
              {
                icon: <BookOpen />,
                label: "Courses",
                value: institutionData.totalCourses,
                color: "green",
              },
              {
                icon: <FileText />,
                label: "Pending Apps",
                value: institutionData.pendingApplications,
                color: "orange",
              },
              {
                icon: <TrendingUp />,
              ...
              {courseStats.map((course) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    {Math.round((course.applications / course.capacity) * 100)}%
                    capacity
                  </p>
                </div>
              ))}
