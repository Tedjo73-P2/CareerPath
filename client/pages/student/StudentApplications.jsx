        ...
        <div className="container-custom">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-lg text-slate-600">
                Track and manage all your course applications
              </p>
            </div>
            <Link
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div
                key={idx}
                className={`rounded-xl p-4 bg-${stat.color}-50 border border-${stat.color}-200`}
              >
                <p className={`text-sm font-medium text-${stat.color}-700`}>
                  {stat.label}
                </p>
          ...
          <div className="space-y-4">
            {applications.length > 0 ? (
              applications.map((app) => (
                <div
                  key={app.id}
                  className={`rounded-xl border p-6 bg-white ${getStatusColor(app.status)}`}
                >
          ...
          <div className="mt-12 bg-blue-50 rounded-xl border border-blue-200 p-8">
            ...
            <ul className="space-y-2 text-blue-800">
              <li>
                • Ensure your GPA meets the institution's minimum requirement
              </li>
              <li>• Check the required documents and deadline dates</li>
              <li>• You can apply to a maximum of 2 courses per institution</li>
              <li>
                • If admitted to multiple institutions, you can choose your
                preferred one
              </li>
