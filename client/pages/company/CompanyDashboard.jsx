...
export default function CompanyDashboard() {
  ...
  const recentApplications = [
    ...
    {
      id: 4,
      applicantName: "Naledi Setshotla",
      position: "Junior Developer",
      status: "new",
      date: "2024-02-19",
    },
        ...
        <div className="container-custom">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600 mt-2">
              Find and hire top talent from our network
            </p>
          </div>
            ...
            {[
              {
                icon: <Briefcase />,
                label: "Active Jobs",
                value: companyData.activeJobs,
                color: "blue",
              },
              {
                icon: <Users />,
                label: "Applications",
                value: companyData.totalApplications,
                color: "green",
              },
              {
                icon: <Eye />,
                label: "Views (Month)",
                value: companyData.viewsThisMonth,
                color: "purple",
              },
              {
                icon: <TrendingUp />,
